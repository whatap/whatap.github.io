...
![alt text](/assets/ifconfig.png "ifconfig")
...
참고>>  
>
Ifconfig명령어로는 private ip밖에 확인되지 않습니다.  
공인아이피(Public IP) 확인하는 방법이 있을까요?  
Curl을 설치후에 확인해 보세요. => curl ifconfig.me 
...
![alt text](/assets/vmstat.png "vmstat")
...
![alt text](/assets/vmstat-s.png "vmstat-s")

참고>>  
>
*실시간으로 메모리 상태를 확인할 수 있습니다.*
방법은? vmstat   [delay [count]  ]  
Ex) vmstat 3 5 : 3초 간격으로 모니터링 정보를 5개 출력하고 끝내라.



**[iostat]**  
평귱 CPU부하 와 디스크 I/O의 세부적인 내용을 확인 할 수 있습니다.

![alt text](/assets/iostat.png "iostat")
...
![alt text](/assets/iostat-x.png "iostat-x")

참고>>  
>
*실시간으로 디스크 상태를 확인할 수 있습니다.*
방법은? iostat  [delay [count]  ]  
Ex) iostat 3 5 : 3초 간격으로 모니터링 정보를 5개 출력하고 끝내라.


**[netstat]**  
현재 시스템에 연결된 네트워크 상태, 라우팅테이블, 인터페이스 상태 등을 볼 수 있습니다.

![alt text](/assets/netstat.png "netstat")
